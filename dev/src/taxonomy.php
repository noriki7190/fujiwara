          ...
          <div class="p-archive-head__tab">
            <ul class="p-category-tab">
              <li class="p-category-tab__item">
                <a href="<?php echo esc_url( home_url( 'news' ) ); ?>" class="p-category-tab__link">全て</a><!-- /.p-category-tab__link -->
              </li><!-- /.p-category-tab__item -->
<?php
  $news_terms = get_terms( 'news', array( 'hide_empty' => false ) );
  foreach ( $news_terms as $news_term ) :

  if ($term === $news_term->slug) :
    // var_dump($news_term);
?>
              <li class="p-category-tab__item">
                <a href="<?php echo get_term_link($news_term->slug, $news_term->taxonomy); ?>" class="p-category-tab__link is-current"><?php echo esc_html( $news_term->name ); ?></a><!-- /.p-category-tab__link -->
              </li><!-- /.p-category-tab__item -->
